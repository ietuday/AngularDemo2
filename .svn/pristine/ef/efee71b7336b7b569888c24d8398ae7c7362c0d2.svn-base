...
exports.getContactHandler = function(message, callback) {
  mongo.findDocument("ContainerVgmContact", {}, function (data) {
    message.message = data;
    message.status = "Success";
    callback(message);
    // mongo.sendWsMessage(connection, message);
...
exports.getProducts = function(message, callback) {
  mongo.findDocument("ProductMaster", {'prod_full_name': {$ne : 'NULL' }}, function (data) {
    message.message = data;
    message.status = "Success";
    callback(message);
    // mongo.sendWsMessage(connection, message);
